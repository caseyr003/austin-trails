...
function AppViewModel(){var e=this;this.searchText=ko.observable(""),this.error=ko.observable(""),this.locationArray=ko.observableArray([]),this.visibleArray=ko.observableArray([]),this.searchOpen=ko.observable(!1),this.openSearch=function(){this.searchOpen(!this.searchOpen())},locations.forEach(function(r){newLocation=new Location(r),newLocation.marker=createMarker(r.title,r.coordinates),e.locationArray.push(newLocation),e.visibleArray.push(newLocation)}),this.locationArray().forEach(function(e){$.ajax({url:"https://api.foursquare.com/v2/venues/"+e.id()+"?client_id="+foursquare_id+"&client_secret="+foursquare_secret+"&v=201701401&m=foursquare",dataType:"json",success:function(r){var a=r.response.venue,s=a.hasOwnProperty("location")?a.location:"";s.hasOwnProperty("address")&&e.address(s.address||"n/a");var t=a.hasOwnProperty("rating")?a.rating:"";e.rating(t||"n/a");var o=a.hasOwnProperty("likes")?a.likes:"";o.hasOwnProperty("summary")&&e.likes(o.summary||"n/a");var i=a.hasOwnProperty("bestPhoto")?a.bestPhoto:"";if(i.hasOwnProperty("prefix")&&i.hasOwnProperty("suffix")){var n=i.prefix+"300x300"+i.suffix;e.photo(n||"n/a")}},complete:function(r){var a='<div class="result-info"><p class="result-title">'+e.title()+'</p><p class="result-address">'+e.address()+'</p><p class="result-rating">'+e.rating()+'</p><p class="result-likes">'+e.likes()+"</p></div>";e.marker.addListener("click",function(){info.open(map,e.marker),info.setContent(a),e.marker.setAnimation(google.maps.Animation.BOUNCE),setTimeout(function(){e.marker.setAnimation(null)},2100)})},error:function(r){var a='<div class="result-info"><p class="result-title">'+e.title+'</p><p class="result-address">Foursquare Data Not Available</p></div>';e.marker.addListener("click",function(){info.open(map,e.marker),info.setContent(a),e.marker.setAnimation(google.maps.Animation.BOUNCE),setTimeout(function(){e.marker.setAnimation(null)},2100)})}})}),this.filteredMarkers=ko.computed(function(){var r=e.searchText().toLowerCase();e.visibleArray.removeAll(),e.locationArray().forEach(function(a){a.marker.setVisible(!1),a.title().toLowerCase().indexOf(r)>-1&&e.visibleArray.push(a)}),0==e.visibleArray().length?e.error("No Results"):(e.error(""),e.visibleArray().forEach(function(e){e.marker.setVisible(!0)}))}),this.getInfo=function(e){google.maps.event.trigger(e.marker,"click"),map.panTo(e.marker.position),map.setZoom(14)}}